...
function renderGame() {         //Funcion que renderiza el juego, se encarga del mov. del pajaro, logica de tuberias, puntaje.
    ...
    context.fillStyle = "white";            //Color texto  
    context.font = "45px sans-serif";       //Fuente y tamaño texto
    context.textAlign = "left";             //Alineacion texto
    context.fillText(score, 5, 45);         //Renderiza el puntaje en la esquina superior izquierda
}
...
function renderGameOver() {     
    if(gameOverImg.complete) {  //Condicional, si la imagen de gameover esta cargada
        ...
        context.fillStyle = "white";                                                  //Color texto
        context.font = "45px sans-serif";                                             //Fuente y tamaño texto
        context.textAlign = "center";                                                 //Alineacion texto
        context.fillText(scoreText, boardWidth / 2, y + imgHeight + 50);              //Renderiza el texto, abajo del gameover
